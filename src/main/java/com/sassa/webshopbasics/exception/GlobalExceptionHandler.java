...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleMethodArgumentTypeMismatch(final MethodArgumentTypeMismatchException ex) {
    ...
    final String error = ex.getName() + " should be of type "
            + (ex.getRequiredType() == null ? "unknown" : ex.getRequiredType().getName());
  ...
  public ResponseEntity<Object> handleIntegrityExceptions(DataIntegrityViolationException ex) {
    final String error = "Incorrect data";
  ...
  public ResponseEntity<Object> objectNotFoundExceptions(UnprocessableEntityException ex) {
    final String error = "Incorrect data";
